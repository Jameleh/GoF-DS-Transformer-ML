 ...
 * @author Kareem Zayed
 */
public class IncomeLastYear extends javax.swing.JFrame {

    /**
     * Creates new form IncomeLastYear
     */
    
    public long total_cost = 0;
    public String end_date, start_date;
    
    public IncomeLastYear() {
        initComponents();
        
        totalincome.setEditable(false);
        
        end_date = getCurrentDate();
        start_date = getStartDate(365);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Income Information Last Year");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel3.setText("Risedents Last Year: ");
        ...
        jLabel2.setText("Income last year: ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IncomeLastYear.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IncomeLastYear().setVisible(true);
            }
        });
    }
