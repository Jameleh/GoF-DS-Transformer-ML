...
private JTextArea theKuisioner = new JTextArea(40,60);
...
public TestMemento(){
	   ...
	   panel1.add(new JLabel("Pertanyaan Survey"));
	   
	   // Add JTextArea to the panel
	   
	   panel1.add(theKuisioner);
...
class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource() == saveBut){
				...
				String textInTextArea = theKuisioner.getText();
				...
				if(e.getSource() == undoBut){
					...
					if(currentArticle >= 1){
						...
						theKuisioner.setText(textBoxString);
