 ...
 */
 ...
 public class ArchivadorComposite {
     public static void main(String[] args) {
         ...
         // subcarpeta de la subcarpeta música
         Carpeta musicaEnIngles = new Carpeta("MúsicaEnInglés");
         ...
         Archivo archivo4 = new Archivo("youth.mp3", 200);
         Archivo archivo5 = new Archivo("love.mp3", 400);
         ...
         musicaEnIngles.añadir(archivo4);       // youth.mp3 dentro de MusicaEnIngles
         musicaEnIngles.añadir(archivo5);       // love.mp3 dentro de MusicaEnIngles
 
         // Añadir carpetas a la raíz
         raiz.añadir(documentos);
         raiz.añadir(imagenes);
         musica.añadir(musicaEnIngles);
         raiz.añadir(musica);
