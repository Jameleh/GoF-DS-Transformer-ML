...
public class Televizor extends SufragerieDecorator
{
	//Constructor and Display a message for the user so that he can make a choice
	public Televizor(Sufragerie decoratedSufragerie) 
	{
		super(decoratedSufragerie);
		System.out.println("Pentru Televizor introduceti una din urmatoarele optiuni: Mic - 700  / Mediu - 1200 / Mare - 2200 / Fara - 0");
	}
	...
	public int getCost() 
	{
		...
		{
		case "Mic":
			System.out.println("Ati ales optiunea Mic");
			return 700;
		case "Mediu":
			System.out.println("Ati ales optiunea Mediu");
			return 1200;
		case "Mare":
			System.out.println("Ati ales optiunea Mare");
			return 2200;
		case "Fara":
			System.out.println("Ati ales optiunea Fara televizor");
			return 0;
		default: return 0;
		}
	}
